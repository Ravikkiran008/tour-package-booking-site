...
?>
 ...
 $sql='SELECT * from tbltourpackages LIMIT 5';
...
<<div class="card mb-3" style="max-width: 80%;margin: auto;margin-top: 10vh;border: transparent;background-color: #4d4d4d; display: flex; flex-direction: column;">
    <div class="row g-0" style="flex: 1;">
        <div class="col-md-3">
            <img src="admin/pacakgeimages/<?php echo ($row["PackageImage"]);?>" id="recipe_img" class="img-fluid rounded-start" alt="..." style='height:200px;width:200px;margin:20px;'>
        </div>
        <div class="col-md-8">
            <div class="card-body">
